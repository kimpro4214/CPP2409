...
int main(){
    ...
    while(true){
        ...
        if(board[2][0] == 'V' && board[2][1] == 'V' && board[2][2] == 'V'){
            cout << "세 번째 유저(V)가 승리했습니다!" << endl;
            break;
        }

        if(board[1][0] == 'V' && board[1][1] == 'V' && board[1][2] == 'V'){
            cout << "세 번째 유저(V)가 승리했습니다!" << endl;
            break;
        }


        if(board[0][2] == 'V' && board[1][1] == 'V' && board[2][0] == 'V'){
            cout << "세 번째 유저(V)가 승리했습니다!" << endl;
            break;
        }
